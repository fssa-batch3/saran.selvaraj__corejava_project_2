...
public class TestRegister {
	...
	public static void main(String[] args) {
		...
		User user1 = new User("saran","selvaraj", "Male", "9500320194", "2004-12-26", "hacker4@gmail.com", "Saran@123");
	...
	// UserService userService = new UserService();
	// User user1 = new User("Kotti_784","Male" ,"9500320194","2004-12-26",
	// "hacker4@gmail.com","Kotie@123");
	// try {
